...
//if(navigator.geolocation){
    //navigator.geolocation.getCurrentPosition(function(position) {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=54.875&lon=37.22&lang=ru&appid=04a8f926516de8567795579044b734ab`)
            ...
            .then(function (data) { 
                for(let i = 0; i < 7; i++){
                    ...
                    document.querySelector(`.day${i}Head`).innerHTML += (`${days[(NowDate.getDay() + i)]} ${(NowDate.getDate() + i)} ${months[NowDate.getMonth()]}<br>`);
